                                ...
                                <div class="col-sm-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="fullname" id="fullname"
                                            ...
                                            value="{{ old('fullname', $employee->fullname) }}" placeholder="Fullname Input...">
                                        @error('fullname')
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="email" name="email" id="email"
                                            ...
                                            value="{{ old('email', $employee->email) }}" placeholder="Email Input...">
                                        @error('email')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" name="phone" id="phone"
                                            ...
                                            value="{{ old('phone', $employee->phone) }}" placeholder="Phone Input...">
                                        @error('phone')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control  @error('address',) is-invalid @enderror" name="address" id="address" rows="3"
                                            placeholder="Address Input...">{{ old('address', $employee->address) }}</textarea>
                                        @error('address')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" name="birth_date" id="birth_date"
                                            ...
                                            placeholder="Select date.." value="{{ old('birth_date', $employee->birth_date) }}">
                                        @error('birth_date')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" name="hire_date" id="hire_date"
                                            ...
                                            placeholder="Select date.." value="{{ old('hire_date', $employee->hire_date) }}">
                                        @error('hire_date')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" name="salary" id="salary"
                                            ...
                                            value="{{ old('salary',$employee->salary) }}" placeholder="Salary Input...">
                                        @error('salary')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
